...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Hosteg Suporte Remoto".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remoto.hosteg.com.br"];
pub const RS_PUB_KEY: &str = "d2cyZil0YaO1dsBQow2kH7UJ+1X1Asw3bW17wdVFxwQ=";
